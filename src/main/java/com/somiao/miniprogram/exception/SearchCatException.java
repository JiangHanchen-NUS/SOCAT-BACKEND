package com.somiao.miniprogram.exception;
 ...
 * @author h1c
 */
public class SearchCatException extends Exception {

    /**
     * Constructs a new exception with {@code null} as its detail message. The cause is not initialized, and may
     * subsequently be initialized by a call to {@link #initCause}.
     */
    public SearchCatException() {
     ...
     *                method.
     */
    public SearchCatException(String message) {
     ...
     * @since 1.4
     */
    public SearchCatException(String message, Throwable cause) {
     ...
     * @since 1.4
     */
    public SearchCatException(Throwable cause) {
     ...
     * @since 1.7
     */
    public SearchCatException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
